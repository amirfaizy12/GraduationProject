...
import { FileText, Paperclip, File as FileIcon, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="editor-section">
      <div className="editor-section-header">
        <div className="editor-section-icon"><FileText size={24} /></div>
        <div>
      ...
      <div className={`upload-zone${uploading ? " disabled" : ""}`}>
        ...
        {uploading ? (
          ...
          <>
            <div className="upload-icon"><Paperclip size={40} color="var(--brand)" /></div>
        ...
        <div className="upload-preview">
          ...
          <div className="upload-preview-info">
            ...
            <div className="upload-preview-status" style={{ display: "flex", alignItems: "center", gap: "4px" }}>
              <CheckCircle size={14} /> CV uploaded
            </div>
          </div>
