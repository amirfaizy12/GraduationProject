...
>
  ...
  <section id="how" className="editor-section">
    <h2 className="editor-section-title">⚡ How it Works</h2>
  ...
  <section id="pricing" className="editor-section">
    <h2 className="editor-section-title">💎 Pricing</h2>
    ...
    >
      ...
      >
        <div>
          <h2 className="editor-section-title">🚀 Ready to build your future?</h2>
          <p className="editor-subtitle">
